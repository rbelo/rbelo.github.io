...
** Remove Sidebar Opacity on Large Screens
...
The simulation =.html= files and =styles.css= in =teaching/dsm/= are copied from the course repo's =simulations/= folder on deploy; only the index page below is tangled from here.

#+begin_src markdown :tangle teaching/dsm/index.md :mkdirp yes
---
layout: single
...
** IEFP
#+begin_src markdown :tangle research-projects/_posts/2025-06-07-iefp.md
---
